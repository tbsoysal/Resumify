...
function Benefits() {
  return (
    <section className={styles.benefits}>
      <h3>Everything you need, simplified</h3>
      <p>No hidden fees, no watermark, no surprises. Your data stays secure, your first resume is free forever, and you can create, edit, and download it whenever you want.</p>
      ...
      <ul>
        <li>
          ...
          <h4>Free forever</h4>
          <p>Your first resume always stays free. No conditions, no hidden fees, no watermark. Download high-quality PDFs when you need them.</p>
        </li>
        <li>
          <div className={styles.imageContainer}>
          ...
          <p>We never sell your data. Period. We're GDPR compliant and you can delete your data anytime. Your data remains under your control.</p>
        </li>
        <li>
          <div className={styles.imageContainer}>
          ...
          <p>From English to Spanish, Chinese, or any other language, Resumify has you covered. Customize all content to your preferred language.</p>
        </li>
        <li>
          <div className={styles.imageContainer}>
          ...
          <p>Copy your resume and easily adapt it for different jobs, regions, or languages. Single-use resumes are a thing of the past.</p>
        </li>
        <li>
          <div className={styles.imageContainer}>
          ...
          <h4>Expert tips at your fingertips</h4>
          <p>Get helpful tips while writing, and use our list of action verbs to perfectly express your achievements.</p>
        </li>
        <li>
          <div className={styles.imageContainer}>
          ...
          <h4>ATS-friendly resumes</h4>
          <p>Many employers use systems that scan resumes for keywords. PDFs you create with Resumify are easily readable by these systems.</p>
        </li>
      </ul>
