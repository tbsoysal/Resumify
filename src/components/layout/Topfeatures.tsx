    ...
    <section className={styles.topfeatures}>
      <ul>
        <li>
          ...
          <p>Your first resume,<br className={styles.breakElement} /> free forever</p>
        </li>
        <li>
          ...
          <p>Privacy &<br className={styles.breakElement} /> GDPR compliant</p>
        </li>
        <li>
          ...
          <p>Professionally<br className={styles.breakElement} /> designed templates</p>
        </li>
      </ul>
    </section>
  )
